...
export default function TermsConditions() {
  ...
  const termsContent = settings?.termsOfServiceText?.length > 0 ? settings.termsOfServiceText : [
    { title: "1. Acceptance of Terms", content: "By accessing and using Authra's services, you agree to be bound by these Terms..." }
  ];

  return (
    <div className="min-h-screen bg-authra-bg-light dark:bg-[#0D0F16] font-inter">
      <Helmet>
        <title>Terms & Conditions | Authra</title>
      </Helmet>
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-12">
          ...
          <section className="text-center space-y-6">
            <div className="w-16 h-16 bg-brand-steel/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <Shield className="w-8 h-8 text-brand-steel" />
            </div>
