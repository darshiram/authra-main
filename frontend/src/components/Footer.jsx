        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-20">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="/features" className="text-authra-text-sec-light dark:text-authra-text-sec-dark hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Features</a>
              <a href="/pricing" className="text-authra-text-sec-light dark:text-authra-text-sec-dark hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Pricing</a>
            </div>

            {/* Company */}
            <div className="flex flex-col gap-4">
              <h4 className="font-[590] text-authra-text-light dark:text-white mb-2">Company</h4>
              <a href="/about" className="text-authra-text-sec-light dark:text-authra-text-sec-dark hover:text-brand-steel dark:hover:text-brand-ice transition-colors">About</a>
              <a href="/careers" className="text-authra-text-sec-light dark:text-authra-text-sec-dark hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Careers</a>
              <a href="/contact" className="text-authra-text-sec-light dark:text-authra-text-sec-dark hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Contact</a>
            </div>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-authra-text-sec-light dark:text-authra-text-sec-dark">
            ...
            <div className="flex items-center gap-4 text-sm">
              <a href="/privacy-policy" className="hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Privacy</a>
              <span>&bull;</span>
              <a href="/terms-conditions" className="hover:text-brand-steel dark:hover:text-brand-ice transition-colors">Terms</a>
            </div>
          </div>

          <div className="flex items-center gap-6 text-authra-text-sec-light dark:text-authra-text-sec-dark">
            <a href={settings?.socialLinks?.linkedin || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-[#0077b5] dark:hover:text-[#0077b5] transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href={settings?.socialLinks?.instagram || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-[#E1306C] dark:hover:text-[#E1306C] transition-colors" aria-label="Instagram">
            ...
            <a href={settings?.socialLinks?.twitter || '#'} target="_blank" rel="noopener noreferrer" className="hover:text-authra-text-light dark:hover:text-white transition-colors" aria-label="X (Twitter)">
